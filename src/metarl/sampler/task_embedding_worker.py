...
class TaskEmbeddingWorker(Worker):
    """Initialize a worker.
    ...
    def step_rollout(self):
        ...
        if self._path_length < self._max_path_length:
            a, agent_info = self.agent.get_action_from_latent(self._z, self._prev_obs)
    ...
    def collect_rollout(self):
        ...
        Returns:
            metarl.TaskEmbeddingTrajectoryBatch: A batch of the trajectories
        ...
        return TaskEmbeddingTrajectoryBatch(
            ...
            np.asarray(tasks), np.asarray(latents),
            dict(latent_infos))
    ...
    def rollout(self):
        ...
        Returns:
            metarl.TaskEmbeddingTrajectoryBatch: The collected trajectory.
