...
fi
{
  ...
  pip install -e .[all]
  pip install -e .[dev]
  pip install git+https://github.com/icml2020submission6857/metaworlds.git@master#egg=metaworlds
  pip install git+https://github.com/icml2020submission6857/viskit.git@master#egg=viskit
