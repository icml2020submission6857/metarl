...
if [[ ! " ${VERIFIED_MACOS_VERSIONS[@]} " =~ " ${VER} " ]]; then
  ...
  print_warning "If this installation is successful, please add your macOS" \
    ...
    "https://github.com/icml2020submission6857/metarl/blob/master/scripts/setup_macos.sh" \
    "on GitHub and submit a pull request to icml2020submission6857/metarl to help out" \
